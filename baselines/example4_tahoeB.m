...
load('../data/Tahoe_preproc_t1.mat','SRF')
...
methods = {'HySure','hysure_adaptor','[]',P;
           ...
           %... 'CB-STAR','cbstar_adaptor','[40 40 3]',{[50,50,4],1};
           'CB-STAR','cbstar_adaptor','[35 35 3]',{[50,50,4],1};
           };

DegMat = struct('Pm', Pm, 'P1', P1, 'P2', P2);
[res, est, optOut] = compare_methods(Zh_th, Yh, Ym, DegMat, decimFactor, methods);

%     'CB-STAR R = [35 3…'    [ 3.9498]    [    2.5974]    [25.2213]    [0.8812]    [58.2403]
...
plot_results(Zh_th, est, alg_names, 'results_examples/ex4_tahoeB');



save_results('results_examples/ex4_tahoeB.txt', res2)
