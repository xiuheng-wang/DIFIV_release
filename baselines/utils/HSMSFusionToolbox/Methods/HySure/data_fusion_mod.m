function [ Zimhat ] = data_fusion_mod( Yhim, Ymim, downsamp_factor, R, B, p, basis_type, lambda_phi, lambda_m , shift, M0)
...
%                                                                       %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% If M0 is supplied, use it, otherwise apply SVD/PCA to find the endmember
% matrix
if nargin < 11
    switch  basis_type 
        case 'VCA'
    ...
    disp('HySure: Using user-supplied endmember matrix...')
    E = M0;
end
